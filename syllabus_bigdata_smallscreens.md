#  JRNL 263: Big Data, Small Screens:

##   The Art and Science of Responsive Data Journalism
...
* Course Location/Time: JRNL 204, MWF, 1 - 1:50 P.M. Lab: M, 2:00 p.m.-5:00 p.m.
* Dedicated Office Location/Hours: JRNL 103, MWF, 2 -3 p.m.
* Outside Office Hours Reservation Scheduling: http://bit.ly/ddjofficehours

* * *

## I.  Rationale

Unlike any time before in our lives, we have access to vast amounts of free information––a phenomena  referred to by scholars as the rise of “Big Data.” With the right tools, we can start to make sense of all this data to see patterns and trends that would otherwise be invisible to us. By transforming numbers into graphical shapes and interactive web apps, we allow users to understand the stories those numbers hide. At the same time, however, the majority of users worldwide now access the web via mobile devices with smaller screen sizes that can complicate the task of creating clear, usable and truthful data visualizations by forcing us to squeeze large amounts of data into limited screen real-estate. Developing theoretical models –– and possibly even practical solutions to –– this challenge of displaying Big Data on small screens will, thus, be an underlying principle throughout this course as we learn the history, theory, guidelines  and technical practice/workflow of data journalism.

## II. Overview and Goals

This four-credit hour lecture and lab course will first analyze the historical, theoretical, statistical and ethical principles behind the nascent field of data-driven journalism, then impart basic-to-intermediate technical skill-sets needed to tell data-driven stories visually and interactively on all screen sizes and devices. Technologies and tutorials will for the most part take place during Monday's lab-time, while analysis and discussion will take place primarily during the three hours of lecture time each week.

Part graphic design, part basic statistics, part computer science, part data science and part shoe-leather reporting, students should leave this course with a thorough grasp of both the *process* and the *product* of obtaining, processing, analyzing and visualizing massive datasets and spreadsheets to convey an accurate and cohesive visual narrative to a non-professional audience on both large and small screen sizes. 
...
* Offer one (1) thoughtful, well-articulated design, data or interaction critique of a popular and/or novel example of data journalism of your choice each week in the form of a blog post published no later than 8 a.m. the morning before each Monday class. Each Monday at the start of class, two students will be chosen beforehand based upon the quality of their blog posts to present their critiques and findings briefly to the class **(critiques account for 10% of course grade).**
*  Reflect critically upon assigned readings for each class, and compose one (1) blog post on each assigned reading no later than 8 a.m.  the morning before each class **(reading responses account for 20% of course grade)**.
* Follow along with in-class/lab programming, data analysis, statistical and visualization tutorials and submit finished work from each tutorial via email no later than the start of the next class meeting. Tutorials will be paced in a manner that you should reasonably be able to complete them in-class. They will also be a available as screencasts uploaded to the class website for later review. But, if you still encounter difficulty, I encourage you to schedule time to meet with me outside of class for further assistance **(guided lab tutorial results submissions account for 10% of course grade)**.
* Produce a total of three (3) individual 'deadline' data journalism/data visualization projects that might be reasonably produced in 1-2 days of full-time work on a topic of current interest. Projects may take the form of an interactive chart, map, dashboard, data-driven game/animation or other visualization, and should include any necessary explanatory text or reporting to compliment the visualization. The projects will be evaluated on both technique and the strength of the underlying data and the story being told **(deadline data journalism projects cumulatively account for 20% of final grade; thus, if you do poorly on your first project and then exceedingly well on your second and third, you could still *in theory* receive a high score overall in this category)**.
...
More than three (3) unexcused absences from lectures or lab time will automatically render your participation grade (which accounts for 15% of your total grade) as zero (0). More than seven unexcused absences will automatically trigger failure of the class.

Given that a large component of the class is structured around your blog post responses and critiques, I will offer feedback regularly in the form of posting comments to your blog entries. It is recommended but in no way mandated that you use WordPress or Tumblr to host your blog; whatever platform or site architecture you choose, just make sure I and classmates can access it and post meaningful comments. If a blog post is deemed to lack sufficient evidence of having read the text, and thus not deserving of serious critical commentary, I will instead email you with feedback privately.
...
This course is inherently interdisciplinary, combining elements of design, statistics, computer science, human-computer interaction and communication studies. But it is still, at its core, a *journalism* course in the sense that its key aim is to help students learn how to distill complex information of public or societal importance into a cogent and engaging narrative for audiences/users. In that regard, then, the course schedule or reading assignments may be subject to change in the event of a major data-rich news event, the publication of a relevant piece of scholarship that contributes to the flow of class discussion or the release of a new technology that expands the possibilities of individual or group projects. This schedule will be embedded as a Google Sheet into the course website to reflect any changes made, and in the event any changes do occur, I will notify the class immediately via email.
* * *

Date	Reading(s)	Lecture Opening Questions	Lab
M, Aug. 14, 2017	Your syllabus! No blog posts due for first class.	What is 'data journalism' and why should I care? Defining "The Many Words for Visualization" (available [here](https://flowingdata.com/2011/09/29/the-many-words-for-visualization/)). Visualization vs. infographic vs. illustration.	Data Journalism with Skittles (no screencast); Charting Crash Course (screencast on course website)
W, Aug. 16, 2017	Manovich, Lev. *The Language of New Media*. 2001. Chapter 5, p. 213-236.   (Available for download [here](http://cvlassets.s3.amazonaws.com/Manovich-Lev_The_Language_of_the_New_Media%20(1).pdf).)	What is the relationship between database and narrative? Why is the database "the center of the process in the computer age"?	
F, Aug. 18, 2017	Manovich, Lev. *The Language of New Media*. 2001. Chapter 5, p. 213-236.   (Available for download [here](http://cvlassets.s3.amazonaws.com/Manovich-Lev_The_Language_of_the_New_Media%20(1).pdf).)	What is the relationship between database and narrative?	
M, Aug. 21, 2017	1. Nyhan, B. et. al. (2012). *Opening the Political Mind:* *The roles of information deficits and identity threat in the prevalence of misperceptions. *(Available for download [here](http://www.dartmouth.edu/~nyhan/opening-political-mind.pdf)). 2. Tufte, Edward. *Data Analysis for Politics and Policy*.	How might visual displays of data create misperceptions? How might they add credibility and lead to a higher rate of correct perceptions?	FIND: Acquiring data from portals, scraping web data and commonly used data formats.  Sourcing data. 
W	TK	TK	
F	TK	TK	
M	TK	TK	ANALYZE: Data Analysis: Spreadsheets 101. 
W	TK	TK	
F	TK	TK	
M	TK	TK	Wireframing and Paper Protoyping with Bootstrap, Interactive Charts with Datawrapper
W	TK	TK	
F	TK	TK	
